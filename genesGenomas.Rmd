...
a <- read.fasta(file = system.file("sequence.fasta")
printf(a)
                

>NC_000913.3:430000..430707 Escherichia coli str. K-12 substr. MG1655, complete genome
ATGCAACGTTTCTGACGCT
```
<!-- Checar ultima respuesta, no estoy seguro de si esta mal -->
