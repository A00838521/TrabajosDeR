...
2. ¿Cuál es la composición de nucleótidos de cada secuencia? (puedes usar conteo, proporción oporcentaje)
3. ¿Cuál es el %GC?
...
5. Crear una gráfica en R, utilizando funciones como plot() o barplot(), donde se muestren las composiciones de nucleótidos
