...
composition_ZIKA <- calculate_nucleotide_composition(ZIKA)
composition_SARS <- calculate_nucleotide_composition(SARS)
composition_WUHAN <- calculate_nucleotide_composition(WUHAN)
composition_MIDDLE <- calculate_nucleotide_composition(MIDDLE)
composition_DENGUE <- calculate_nucleotide_composition(DENGUE)
